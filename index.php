			   ...
			   <div class="main_title_2">
					...
					<div class="row">
						<div class="col-lg-3 col-sm-12 mb-3">
                           <div class="card  customize-card w-max-content overflow-hidden">
							<img src="./img/card-image-1.jpg" alt="">
							<div class="card-content p-3">
								<h5 class=" t-color-red pb-2">Co-operative Learning</h5>
						...
						<div class="card  customize-card w-max-content overflow-hidden	">
							...
							<div class="card-content p-3">
								<h5 class="t-color-red pb-2">Cultural Anchoring</h5>
								<p class="card-description margin-0 ">
						...
						<div class="card  customize-card w-max-content overflow-hidden	">
							...
							<div class="card-content p-3">
								<h5 class=" t-color-red pb-2">Communication &  Self-Expression</h5>
								<p class="card-description margin-0">
						...
						<div class="card  customize-card w-max-content overflow-hidden	">
							...
							<div class="card-content p-3">
								<h5 class=" t-color-red pb-2">Critical Thinking</h5>
								<p class="card-description margin-0">
