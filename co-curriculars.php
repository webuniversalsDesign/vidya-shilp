    ...
    <div id="page">
        ...
        <main>
            ...
            <div class="breadcrumb-section">
                <div class="head">
                    <h1 class="text-center fadeInUp">Co-curricular </h1>
                    <p class="text-center t-color-white"><a href="index.php">Home</a> / Co-curriculars</p>
                </div>
            </div>
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-md-5">
                        ...
                        <p class="pt-4 margin-0">Vidyashilp School lays a strong emphasis on sports and
                            ...
                            create a sense of belonging. At the outset, Vidyashilp School plans to offer coaching
                            in cricket, athletics, football and basketball.</p>
                    </div>
                ...
                <div class="row py-5 align-items-center">
                    ...
                    <div class="col-md-5">
                        ...
                        <p class="pt-4 margin-0">A valuable segment of the curriculum as it supports personal, social, moral,
                            ...
                            as an integral component of other subjects. Fine Arts also include learning activities like basket weaving, Rangoli etc</p>
                    </div>
                ...
                <div class="row py-3 align-items-center">
                    ...
                    <div class="col-md-5">
                        ...
                        <p class="pt-4 margin-0">Dance and theatre give form to feelings and help students
                            ...
                            of teaching socio-emotional skills.</p>
                    </div>
                    <div class="col-md-1"></div>
                    <div class="col-md-5">
                        <div class="currucular-img">
                ...
                <div class="row py-5 align-items-center">
                    ...
                    <div class="col-md-5">
                        ...
                        <p class="pt-4 margin-0">A key tenet of a child’s individuality
                            ...
                            public speaking skills also help students through their
                            life in various aspects of personal and professional growth.</p>
                    </div>
